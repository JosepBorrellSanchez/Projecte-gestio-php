        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<br>
                    <center><input name="canvipassword" placeholder="Actual paraula de pas"></center>
                    <center><input name="canvipasswordnova" placeholder="Nova paraula de pas"></center>
                    <center><input name="canvipasswordnovaconf" placeholder="Confirma la nova paraula de pas"></center>
